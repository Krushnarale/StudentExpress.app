    ...
    public static void seedIfEmpty() {
        new Thread(() -> {
            try {
                ...
                if (users.isEmpty()) {
                    System.out.println("[FirebaseSeedService] Seeding initial users...");
                    userDAO.save(new User("1", "Darshan", "darshan@gmail.com", "+91 94050 53651", User.Role.STUDENT, "123456"));
                    userDAO.save(new User("2", "Property Owner", "owner@express.com", "+91 98220 12345", User.Role.OWNER, "123456"));
                    userDAO.save(new User("3", "Campus Seller", "seller@express.com", "+91 98500 67890", User.Role.SELLER, "123456"));
                    userDAO.save(new User("4", "Service Provider", "provider@express.com", "+91 94221 44556", User.Role.SERVICE_PROVIDER, "123456"));
                    userDAO.save(new User("5", "System Admin", "admin@express.com", "+91 91234 88990", User.Role.ADMIN, "123456"));
                }
                ...
                // 5. Roommates
                RoommateDAO roommateDAO = new RoommateDAOImpl();
                List<RoommateItem> roommates = roommateDAO.findAll();
                if (roommates.isEmpty()) {
                    System.out.println("[FirebaseSeedService] Seeding initial roommates...");
                    roommateDAO.save(new RoommateItem("rm1", "Aditya Joshi", "Kothrud, Pune", "₹ 4,000 - ₹ 6,000 / mo", "Non-smoker, Quiet", "Male", "Final year B.Tech CS student looking for a flatmate near campus.", "+91 99887 76655"));
                    roommateDAO.save(new RoommateItem("rm2", "Ananya Sharma", "Baner, Pune", "₹ 5,000 - ₹ 7,500 / mo", "Studious, Clean", "Female", "MBA student looking for a female roommate for a spacious AC room.", "+91 99776 65544"));
                }
