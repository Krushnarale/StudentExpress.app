...
public class HomePage {
    ...
    public Node getPageNode(
        ...
        String userName = DataRepository.getInstance().getCurrentUser().getName();
        ...
        // Populate dynamic recommended listing cards using DataRepository by ID
        DataRepository repo = DataRepository.getInstance();
        List<RoomItem> rooms = repo.getRooms();
        List<ProductItem> products = repo.getProducts();
    ...
    private Button createCategoryCard(String iconPath, String title, String subtitle, Runnable action) {
        VBox box = new VBox(8);
        ...
        Node iconNode = IconFactory.getIconNode(iconPath, Theme.PRIMARY, 24);
        ...
        box.getChildren().addAll(iconBadge, titleTxt, subTxt);
        ...
        btn.setStyle(Theme.cardStyle() + " -fx-cursor: hand;");
        String defaultStyle = Theme.cardStyle() + " -fx-cursor: hand;";
        String hoverStyle = Theme.elevatedCardStyle() + " -fx-cursor: hand; -fx-translate-y: -2px;";
